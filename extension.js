...
function activate(context) {
  ...
  console.log('Congratulations, your extension "ant" is now active!');
  ...
  let sayHello = vscode.commands.registerCommand(
    "extension.sayHello",
    function() {
      vscode.window.showInformationMessage("This is a new hello command");
    }
  );

  context.subscriptions.push(sayHello);

  // let saySample = vscode.commands.registerCommand(
  //   "extension.saySample",
  //   () => {
  //     // The code you place here will be executed every time your command is executed
